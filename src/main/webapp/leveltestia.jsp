...
<%@page import="dao.*,model.*,controller.*,java.util.*;" %>
<% readingDao rdo=new readingDao();
  choiceDao cdao=new choiceDao();
  truefalseDao tfdao=new truefalseDao();
  blankDao bdao=new blankDao();
  reading read=rdo.levelTest2();
  
  List<choice> clist=cdao.getchoicelevelTest2();
  List<truefalse> tflist=tfdao.truefalselevelTest2();
  List<blank> blist=bdao.blanklevelTest2();
%>
